...
- Consult the maintainer's private infra notes (outside this repository) for existing resources. Never read or reveal infra/secrets values for routine setup.
